...
requirements = read(here/'requirements.txt').splitlines()
requirements_dev = read(here/'requirements_dev.txt').splitlines()
...
setup(
    ...
    #
    # And where it will live on PyPI: https://pypi.org/project/{{ cookiecutter.project_slug }}/
    #
    ...
    url='https://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.project_slug }}',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author="{{ cookiecutter.full_name.replace('\"', '\\\"') }}",  # Optional
    ...
    # larger catalog.
    keywords='{{ cookiecutter.project_slug }}',  # Optional
    ...
    package_data={  # Optional
        '{{ cookiecutter.project_slug }}': ['package_data.dat'],
    },
